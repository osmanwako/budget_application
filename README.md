...
**[Budget Application]** is a guide for how to effectively incorporate modules into my classes in Ruby.
...
```
git clone https://github.com/osmanwako/budget_application.git
```
...
Feel free to check the [issues page](https://github.com/osmanwako/budget_application/issues).
